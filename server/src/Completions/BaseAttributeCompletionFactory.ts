...
import { BaseElement, BaseAttribute, SimpleAttribute, BindableAttribute, EmptyAttribute, GlobalAttributes, Event } from './Library/_elementStructure';
...
export default class BaseAttributeCompletionFactory {
  ...
  protected addAttributes(attributes: Map<string, BaseAttribute>, result: CompletionItem[], existingAttributes: string[], quote: string) {
